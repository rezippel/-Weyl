...
;;; $Header: space-classes.lisp,v 1.11 1995/05/30 18:10:14 rick Exp $
...
;; Has-name is defined in algebraic-domains.lisp
...
(defclass function-space (vector-space #+ignore dimensional-space ring)
...
(defmethod initialize-instance :after ((h function-space) &rest plist)
  ...
  (with-slots (print-function) h
    (setf print-function 'function-space-print-object)))
